              ...
              {role && (
                ...
                >
                  ...
                  <motion.div variants={itemVariants} className="relative">
                    <div
                      className={`absolute inset-0 flex items-center ${isDark ? "border-slate-700" : "border-slate-300"} border-t`}
                    ></div>
                    <div className="relative flex justify-center text-sm">
                      <span
                        className={`px-2 ${isDark ? "bg-slate-900" : "bg-white"} ${isDark ? "text-slate-400" : "text-slate-600"}`}
                      >
                        Or continue with
                      </span>
                    </div>
